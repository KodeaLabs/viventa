...
/**
 * Property type labels - vacation/luxury focused
 */
export const propertyTypeLabels: Record<string, { en: string; es: string }> = {
  beach_apartment: { en: 'Beach Apartment', es: 'Apartamento Playa' },
  apartment: { en: 'Apartment', es: 'Apartamento' },
  house: { en: 'House', es: 'Casa' },
  villa: { en: 'Villa', es: 'Villa' },
  penthouse: { en: 'Penthouse', es: 'Penthouse' },
  finca: { en: 'Finca / Estate', es: 'Finca' },
  townhouse: { en: 'Townhouse', es: 'Casa Adosada' },
  beach_house: { en: 'Beach House', es: 'Casa de Playa' },
